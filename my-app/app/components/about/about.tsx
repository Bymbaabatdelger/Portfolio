...
const About = () => {
  return (
    <div className="flex flex-col lg:flex lg:flex-row gap-4 text-slate-200">
      ...
      <div>
        <p className="text-[8px] font-medium lg:text-[12px]">As a passionate and dedicated developer with a focus on the Full-stack. I had the opportunity to apply theoretical knowledge in real-world scenarios,
