const About = () => {
  return (
    <div className="flex flex-col lg:flex lg:flex-row gap-4 text-slate-200">
      ...
      <div>
        <p className="text-[8px] font-medium lg:text-[12px]">As a passionate and dedicated developer with a focus on the MERN stack, I have cultivated a robust foundation in full-stack web development over the past eight months.
        Following this period of rigorous study, I honed my skills further through a two-month immersive experience at Pinecone Academy. Here, I had the opportunity to apply theoretical knowledge in real-world scenarios,
